...
# WARNING: Ensure imports from `python_fast_api_scaffold` comes after this line
from python_fast_api_scaffold import app, settings, db  # noqa
from python_fast_api_scaffold.cli import create_user, cli  # noqa
